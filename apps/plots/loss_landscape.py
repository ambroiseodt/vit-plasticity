...
def get_latex_frames(save: bool) -> None:
    # Figure parameters
    width = 4
    height = 4
    nrows = 2
    ...
    ax4 = fig.add_subplot(gs[1, 1])
    cont4 = ax4.contourf(X_mha, Y_mha, Z_loss_mha, levels=40, cmap=cmap, vmin=row2_min, vmax=row2_max)
...
def get_frames(save: bool) -> None:
    ...
    surf2.set_edgecolor((1, 1, 1, alpha_surface))
...
def plot_latex_frames() -> None:
    save = True
    get_latex_frames(save=save)
